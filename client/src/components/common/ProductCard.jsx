...
const ProductCard = ({ title, price, image, category }) => {
    return (
        <div className="group relative bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-earth-100 h-full flex flex-col">
            {/* Image Container */}
            <div className="relative aspect-square overflow-hidden bg-earth-100 shrink-0">
                <img
                    src={image}
                    alt={title}
            ...
            <div className="p-4 flex flex-col flex-grow">
                <h3 className="font-serif text-xl font-bold text-earth-900 mb-1 group-hover:text-terracotta-600 transition-colors line-clamp-1">
                    {title}
                </h3>
